...
MSlave::MSlave(MPanelSlave* ps, std::shared_ptr<opendnp3::IChannel> ch, const std::string& name,opendnp3::LogLevels fl, const opendnp3::OutstationStackConfig& cfg) :
 panel_slave(ps), stackconfig(cfg), moa(std::make_shared<MOutstationApplication>(this))
{
